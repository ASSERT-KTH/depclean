package se.kth.jdbl.pom.tree.analysis;

import org.apache.maven.artifact.Artifact;
import se.kth.jdbl.pom.tree.InputType;
import se.kth.jdbl.pom.tree.Node;
import se.kth.jdbl.pom.tree.ParseException;
import se.kth.jdbl.pom.tree.Parser;
import se.kth.jdbl.pom.util.MavenDependencyUtils;
...
public class DependencyTreeAnalyzer implements Serializable {
    ...
    /**
     * Count the number of artifacts in the tree
     */
    public int sizeOfDependencyTree() {
        return getAllDependenciesCoordinates(rootNode).size();
    }
